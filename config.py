...
# BLACKBOX HTTP AGENT (adapter for externally deployed black-box agents, e.g. cockpit)
# Override via BLACKBOX_HTTP_* environment variables (see .env.example) or --agent-llm-args.
DEFAULT_BLACKBOX_HTTP_BASE_URL = "http://localhost:8080"
DEFAULT_BLACKBOX_HTTP_ENDPOINT = "/chat"
DEFAULT_BLACKBOX_HTTP_TIMEOUT = 120.0  # seconds
DEFAULT_BLACKBOX_HTTP_MAX_RETRIES = 2
DEFAULT_BLACKBOX_HTTP_RETRY_BACKOFF_SECONDS = 1.0
